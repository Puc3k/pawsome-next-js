...
const QuizContent: React.FC<QuizContentProps> = ({
  ...
  if (isLoading || !leftImage || !rightImage && quizState.pool.length > 1) {
    return (
      <section
        className="relative mx-auto pt-8 pb-16 overflow-hidden bg-gray-50">
        <div>
          <h1
  ...
  if (quizState.pool.length === 1) {
    return <section
      ...
      <div className="relative z-10">
        <WinnerDogImage imageUrl={ quizState.pool[0] } onReset={ handleReset }/>
      </div>
    </section>
  }
